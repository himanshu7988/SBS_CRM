...
import { DeleteLedger, GetContactList } from "@/config/Api";
...
const ContactListModal = ({
  ...
  }, [isOpenModal, loaded, searchData, page, rowsPerPage]);
  ...
  return (
    <>
        ...
        <ModalContent>
          <ModalHeader className="flex flex-col gap-1">
            ...
            <p className="text-sm text-red-500">
              For : {currentDataPrev?.companyName}
            </p>
          </ModalHeader>
          <ModalBody>
            <div className="w-full">
              <div className=" px-4 py-4 flex items-center justify-between rounded-tl-lg rounded-tr-lg bg-white">
      ...
      <AddContactModal
        formFor={formFor}
        currentDataPrev={currentDataPrev}
